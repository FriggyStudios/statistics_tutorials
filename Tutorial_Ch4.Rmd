...
strict_check(success = "Based on the (possibly dubious) assumption that the underlying population of Walking Times follows a Normal distribution, a 95% Confidence Interval for the population mean Walking Time is given in Box 4.7.1.2 and suggests that the population average walking time is likely to be between 52 and 198 minutes per week.
