...
ggplot(mapping = aes(x = POWER$Body_Mass, y = POWER$Wingate)) +
  geom_point() +
  geom_smooth(mapping = aes(x = male$Body_Mass, y = male$Wingate),method='loess',level = 0) +
  geom_smooth(mapping = aes(x = female$Body_Mass, y = female$Wingate),method='loess',level = 0)
```
